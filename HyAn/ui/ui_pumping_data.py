...
class Ui_PumpingData(object):
    def setupUi(self, PumpingData):
        ...
        self.table_drawdown.setObjectName("table_drawdown")
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(
            self.table_drawdown.sizePolicy().hasHeightForWidth()
        )
        ...
        self.btn_plt_data.setObjectName("btn_plt_data")
        ...
        self.wid_plt_graph.setObjectName("wid_plt_graph")
    ...
    def retranslateUi(self, PumpingData):
        PumpingData.setWindowTitle(
            QCoreApplication.translate("PumpingData", "Form", None)
        )
        self.gb_dicharge.setTitle(
            QCoreApplication.translate("PumpingData", "Discharge[m\u00b3/sec]", None)
        )
        self.lbl_constant.setText(
            QCoreApplication.translate("PumpingData", "Constant:", None)
        )
        self.btn_plt_data.setText(
            QCoreApplication.translate("PumpingData", "Plot Data", None)
        )
