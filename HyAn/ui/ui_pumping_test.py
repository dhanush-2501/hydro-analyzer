...
class Ui_PumpingTest(object):
    def setupUi(self, PumpingTest):
        ...
        self.lbl_site_plan_2.setObjectName("lbl_site_plan_2")
        ...
        self.cb_site_plan_2.addItem("")
        self.cb_site_plan_2.addItem("")
        self.cb_site_plan_2.setObjectName("cb_site_plan_2")
        ...
        self.cb_pressure_2.addItem("")
        self.cb_pressure_2.addItem("")
        self.cb_pressure_2.setObjectName("cb_pressure_2")
    ...
    def retranslateUi(self, PumpingTest):
        ...
        self.lbl_site_plan_2.setText(
            QCoreApplication.translate("PumpingTest", "Site Plan:", None)
        )
        self.cb_dimensions_2.setItemText(
            0, QCoreApplication.translate("PumpingTest", "m", None)
        )
        self.cb_dimensions_2.setItemText(
            1, QCoreApplication.translate("PumpingTest", "cm", None)
        )
        self.cb_dimensions_2.setItemText(
            2, QCoreApplication.translate("PumpingTest", "mm", None)
        )
        self.cb_dimensions_2.setItemText(
            3, QCoreApplication.translate("PumpingTest", "ft", None)
        )
        self.cb_dimensions_2.setItemText(
            4, QCoreApplication.translate("PumpingTest", "in", None)
        )

        self.cb_site_plan_2.setItemText(
            0, QCoreApplication.translate("PumpingTest", "mm", None)
        )
        self.cb_site_plan_2.setItemText(
            1, QCoreApplication.translate("PumpingTest", "cm", None)
        )
        self.cb_site_plan_2.setItemText(
            2, QCoreApplication.translate("PumpingTest", "m", None)
        )
        self.cb_site_plan_2.setItemText(
            3, QCoreApplication.translate("PumpingTest", "ft", None)
        )
        ...
        self.cb_discharge_2.setItemText(
            0, QCoreApplication.translate("PumpingTest", "m\u00b3/sec", None)
        )
        self.cb_discharge_2.setItemText(
            1, QCoreApplication.translate("PumpingTest", "m\u00b3/min", None)
        )
        self.cb_discharge_2.setItemText(
            2, QCoreApplication.translate("PumpingTest", "m\u00b3/hr", None)
        )
        self.cb_discharge_2.setItemText(
            3, QCoreApplication.translate("PumpingTest", "m\u00b3/day", None)
        )
        self.cb_discharge_2.setItemText(
            4, QCoreApplication.translate("PumpingTest", "l/s", None)
        )
        self.cb_discharge_2.setItemText(
            5, QCoreApplication.translate("PumpingTest", "ft\u00b3/sec", None)
        )
        self.cb_discharge_2.setItemText(
            6, QCoreApplication.translate("PumpingTest", "ft\u00b3/min", None)
        )
        self.cb_discharge_2.setItemText(
            7, QCoreApplication.translate("PumpingTest", "ft\u00b3/hr", None)
        )
        self.cb_discharge_2.setItemText(
            8, QCoreApplication.translate("PumpingTest", "ft\u00b3/day", None)
        )
        self.cb_discharge_2.setItemText(
            9, QCoreApplication.translate("PumpingTest", "U.S gal/min", None)
        )
        self.cb_discharge_2.setItemText(
            10, QCoreApplication.translate("PumpingTest", "U.S gal/day", None)
        )
        self.cb_discharge_2.setItemText(
            11, QCoreApplication.translate("PumpingTest", "U.K gal/min", None)
        )
        self.cb_discharge_2.setItemText(
            12, QCoreApplication.translate("PumpingTest", "U.K gal/day", None)
        )
        ...
        self.cb_time_2.setItemText(
            0, QCoreApplication.translate("PumpingTest", "sec", None)
        )
        self.cb_time_2.setItemText(
            1, QCoreApplication.translate("PumpingTest", "min", None)
        )
        self.cb_time_2.setItemText(
            2, QCoreApplication.translate("PumpingTest", "hr", None)
        )
        self.cb_time_2.setItemText(
            3, QCoreApplication.translate("PumpingTest", "day", None)
        )

        self.lbl_transmissivity_2.setText(
            QCoreApplication.translate("PumpingTest", "Transmissivity:", None)
        )
        self.lbl_pressure_2.setText(
            QCoreApplication.translate("PumpingTest", "Pressure:", None)
        )
        self.cb_pressure_2.setItemText(
            0, QCoreApplication.translate("PumpingTest", "Pa", None)
        )
        self.cb_pressure_2.setItemText(
            1, QCoreApplication.translate("PumpingTest", "bar", None)
        )
        self.cb_pressure_2.setItemText(
            2, QCoreApplication.translate("PumpingTest", "mbar", None)
        )
        self.cb_pressure_2.setItemText(
            3, QCoreApplication.translate("PumpingTest", "mm Hg", None)
        )
        self.cb_pressure_2.setItemText(
            4, QCoreApplication.translate("PumpingTest", "atm", None)
        )
        self.cb_pressure_2.setItemText(
            5, QCoreApplication.translate("PumpingTest", "at", None)
        )
        self.cb_pressure_2.setItemText(
            6, QCoreApplication.translate("PumpingTest", "psi", None)
        )
        ...
        self.cb_transmissivity_2.setItemText(
            4, QCoreApplication.translate("PumpingTest", "ft\u00b2/sec", None)
        )
        self.cb_transmissivity_2.setItemText(
            5, QCoreApplication.translate("PumpingTest", "ft\u00b2/min", None)
        )
        self.cb_transmissivity_2.setItemText(
            6, QCoreApplication.translate("PumpingTest", "ft\u00b2/hr", None)
        )
        self.cb_transmissivity_2.setItemText(
            7, QCoreApplication.translate("PumpingTest", "ft\u00b2/day", None)
        )
        self.cb_transmissivity_2.setItemText(
            8, QCoreApplication.translate("PumpingTest", "gal/day-ft", None)
        )
        self.cb_transmissivity_2.setItemText(
            9, QCoreApplication.translate("PumpingTest", "cm\u00b2/sec", None)
        )
