...
class Ui_Analysis(object):
    def setupUi(self, Analysis):
        ...
        self.gb_solution.setObjectName("gb_solution")
        ...
        icon = QIcon()
        icon.addFile(":/menu_bar_icon/settings.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(":/menu_bar_icon/report.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.wid_analysis_graph.setObjectName("wid_analysis_graph")
    ...
    def retranslateUi(self, Analysis):
        Analysis.setWindowTitle(QCoreApplication.translate("Analysis", "Form", None))
        self.gb_analysis.setTitle(
            QCoreApplication.translate("Analysis", "Analysis", None)
        )
        self.lbl_analysis_name.setText(
            QCoreApplication.translate("Analysis", "Analysis Name:", None)
        )
        self.lbl_analysis_performed_by.setText(
            QCoreApplication.translate("Analysis", "Analysis Performed by:", None)
        )
        self.lbl_analysis_data.setText(
            QCoreApplication.translate("Analysis", "Analysis date:", None)
        )
        self.gb_solution.setTitle(
            QCoreApplication.translate("Analysis", "Solution", None)
        )
        self.btn_fit.setText(QCoreApplication.translate("Analysis", "Fit Data", None))
        self.gb_output.setTitle(QCoreApplication.translate("Analysis", "Output", None))
        self.lbl_output_storativity.setText(
            QCoreApplication.translate("Analysis", "Storativity:", None)
        )
        self.lbl_output_transmissivity.setText(
            QCoreApplication.translate("Analysis", "Transmissivity:", None)
        )
        self.btn_generate_report.setText(
            QCoreApplication.translate("Analysis", "Generate Report", None)
        )
